---
description: "Generate personalized productivity tips from recent project work, repository history, notes, and provided session exports."
mode: subagent
...
permission:
  ...
  bash:
    ...
    "rm -rf *": deny
---
You analyze recent project work and provide practical productivity tips.
